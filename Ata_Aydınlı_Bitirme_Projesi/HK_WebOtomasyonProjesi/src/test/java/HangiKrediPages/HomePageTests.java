...
public class HomePageTests extends BaseTest {
    ...
    @Test
    @Parameters({"browser", "loanTerm"})
    public void controlInterestRate (
            @Optional("chrome") String browser, @Optional("9") String loanTerm) throws InterruptedException {
        setupTest(browser);
        new HomePage()
                .navigateToUrl(GetData.URL.PERSONAL_FINANCE_CREDIT.value)
                .controlCreditSuggestions(loanTerm)
                .controlConsumerLoanListInterestRate();
        ;
    }
